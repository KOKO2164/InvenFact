...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('reportes.pedidos') }}" method="GET" class="row">
                ...
                <div class="text-right col-md-12">
                    ...
                    <a href="{{ route('reportes.pedidos') }}" class="btn btn-secondary">
                        <i class="fas fa-sync"></i> Reiniciar
                    </a>
                    <a href="{{ route('reportes.exportar-pedidos', request()->all()) }}" class="btn btn-success">
                        <i class="fas fa-download"></i> Exportar a Excel
                    </a>
                    <a href="{{ route('reportes.pdf-pedidos', request()->all()) }}" class="btn btn-danger" target="_blank">
