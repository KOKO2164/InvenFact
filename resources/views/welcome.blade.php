    ...
    <div class="row">
        <div class="col-md-4">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>Bienvenido, <span id="nombreUsuario">{{ $user->nombre }}</span></h3>
                    <h4><span id="correoUsuario">{{ $user->email }}</span></h4> 
                    <h4>Tu Rol es <span id="rolUsuario" 
                        ...
                        {{ $user->rol->nombre }}</span></h4>
                    <h4><span id="fechaActual">{{ $fechaActual }}</span>, <span id="horaActual">{{ $horaActual }}</span></h4>
                    <h4>{{$ubicacion}}</h4>
