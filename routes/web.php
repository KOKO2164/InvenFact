...
Route::resource('/productos', ProveedorController::class)->except('show', 'destroy')->parameters(['productos' => 'producto'])->middleware('auth');
Route::patch('/productos/{producto}/deshabilitar', [ProveedorController::class, 'disable'])->name('productos.disable')->middleware('auth');
Route::patch('/productos/{producto}/habilitar', [ProveedorController::class, 'enable'])->name('productos.enable')->middleware('auth');